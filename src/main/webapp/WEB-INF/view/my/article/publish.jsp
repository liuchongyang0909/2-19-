...
<body>
	...
	<form id="form1">
		...
		<div class="form-group">
			...
			<textarea name="content" cols="100" rows="8" style="width:100%;height:300px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
			<br />
